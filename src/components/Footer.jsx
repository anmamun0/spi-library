  ...
  return (
    <footer className="bg-slate-800 text-white pt-12 pb-8 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 sm:grid-cols-2 gap-8 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="/books" className="hover:text-amber-400">
                Browse Books
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/admin" className="hover:text-amber-400">
                Admin Panel
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            <li>
              Email:{" "}
              <a
                href="mailto:librarian@spi.edu.bd"
      ...
      <div className="border-t border-slate-600 mt-8 pt-6 text-center text-gray-400 text-sm">
        &copy; {new Date().getFullYear()} Sylhet Polytechnic Library System. All
        rights reserved.
      </div>
    </footer>
  );
