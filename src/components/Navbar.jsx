    ...
    <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <div>
            <img src={logo} alt="Library Logo" className="w-20 h-20" />
          </div>
          <div className="block pt-3">
            <span className="text-xl text-left font-bold text-blue-700 uppercase">
              SPI-Library
            </span>
            <span className="block">Sylhet Polytechnic Institute</span>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center space-x-4">
          ...
          <div className="flex">
            <button className="bg-blue-800 text-white px-4 py-2 rounded">
              <a href="/bookdetails">My Account</a>
      ...
      {/* Full Menu Bar */}
      <div className="container mx-auto px-4 bg-slate-800 text-white text-sm font-medium hidden lg:flex relative">
        <ul className="flex space-x-6 py-3">
          ...
          {/* Other links */}
          <li>
            <Link to="/book" className="hover:text-amber-400">
              eBooks & Audiobooks
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/" className="text-amber-400 hover:text-white">
              Library Card
            </Link>
          </li>
        </ul>
