...
const BookDetails = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start bg-gray-100 py-10 rounded-lg">
        <div className=" ">
          <img
            src={book.image}
            alt={book.title}
        ...
        <div className=" my-auto p-4">
          ...
          <div className="mt-2">
            <span
              className={`inline-block px-4 py-1 text-md font-medium rounded-xl border border-green-500  ${
                book.available > 0
